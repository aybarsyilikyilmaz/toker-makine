      ...
      <div className={`container ${styles.footerGrid}`}>
        <div className={styles.colLogo}>
          ...
          <div className={styles.socials}>
            <a href="https://wa.me/905325721261" target="_blank" rel="noreferrer" className={styles.wpColor}><MessageCircle size={22} /></a>
        ...
        <div className={styles.colContact}>
          ...
          <ul className={styles.contactList}>
            ...
            <li>
              ...
              <span style={{ fontSize: '0.85rem' }}>tokermakina@gmail.com</span>
            </li>
          </ul>
        </div>
      </div>
